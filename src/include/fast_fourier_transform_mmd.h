...
#ifndef VISQOL_INCLUDE_FAST_FOURIER_TRANSFORM_MMD_H
#define VISQOL_INCLUDE_FAST_FOURIER_TRANSFORM_MMD_H
...
#endif  // VISQOL_INCLUDE_FAST_FOURIER_TRANSFORM_MMD_H
